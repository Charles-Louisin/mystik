...
function SendMessageContent({ recipientLink }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Logs détaillés des données du formulaire avant envoi
    console.log('=== DONNÉES DU FORMULAIRE AVANT ENVOI ===');
    console.log('Contenu:', formData.content);
    console.log('Surnom:', formData.nickname);
    console.log('Indice:', formData.hint);
    ...
    console.log('Filtre émotionnel:', formData.emotionalFilter);
    console.log('Message vocal présent:', !!formData.voiceMessage);
    console.log('==========================================');
